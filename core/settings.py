...
SECRET_KEY = 'django-insecure-_eqhai_j+7=7&9&8p2bbbe+mqiec=7o$rm=)kppw0o+*7kz)wa'
...
#Django Caching Framework: Implement caching for frequently accessed data to improve performance.
# CACHES = {
#     'default': {
